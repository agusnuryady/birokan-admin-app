...
export function DeclarationEditor({
  ...
  const debouncedSetContent = useDebouncedCallback(
    (html: string) => {
      form.setFieldValue(`declarations.${idx}.content`, html);
    },
    300 // ms
  );
      ...
      <Group align="start" wrap="nowrap">
        <Stack style={{ flex: 1 }} gap="xs">
          <TextInput
            ...
            {...form.getInputProps(`declarations.${idx}.title`)}
            required
          />
          ...
          <TextInput
            ...
            {...form.getInputProps(`declarations.${idx}.boldText`)}
          />
