...
type CompleteOrderDeclarationEditorProps = {
  idx: number;
  declaration: ProcedureDeclarationInput;
...
export function CompleteOrderDeclarationEditor({
  idx,
  declaration,
  form,
  removeDeclaration,
}: CompleteOrderDeclarationEditorProps) {
  const debouncedSetContent = useDebouncedCallback(
    (html: string) => {
      form.setFieldValue(`completeForms.${idx}.content`, html);
    },
    300 // ms
  );
      ...
      <Group align="start" wrap="nowrap">
        <Stack style={{ flex: 1 }} gap="xs">
          <TextInput
            ...
            {...form.getInputProps(`completeForms.${idx}.title`)}
            required
          />
          ...
          <TextInput
            ...
            {...form.getInputProps(`completeForms.${idx}.boldText`)}
          />
